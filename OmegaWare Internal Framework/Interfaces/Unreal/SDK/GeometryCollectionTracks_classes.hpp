...
{
public:
	struct FMovieSceneGeometryCollectionParams    Params;                                            // 0x00F0(0x0030)(Edit, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                         Pad_1665[0x8];                                     // 0x0098(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
