...
public:
	...
	uint8                                         Pad_262C[0x8];                                     // 0x00D0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigVMMemoryContainer                  LiteralMemoryStorage;                              // 0x00D8(0x00A0)(NativeAccessSpecifierPublic)
	uint8                                         Pad_262D[0x8];                                     // 0x0178(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigVMByteCode                         ByteCodeStorage;                                   // 0x0180(0x0030)(NativeAccessSpecifierPublic)
	uint8                                         Pad_262E[0x8];                                     // 0x01B0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_262F[0x20];                                    // 0x0230(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2630[0x48];                                    // 0x02B0(0x0048)(Fixing Size After Last Property [ Dumper-7 ])
