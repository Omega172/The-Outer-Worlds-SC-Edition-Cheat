...
void UWeaponSelect_BP_C::BndEvt__Radial_K2Node_ComponentBoundEvent_1_SectionSelectedSignature__DelegateSignature(int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
void UWeaponSelect_BP_C::OnSectionSelected(int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
void UWeaponSelect_BP_C::SetBackgroundVisibility(TArray<class UWeaponRadialBackgroundSection_BP_C*>& Array, int32 Param_Index, bool Enabled)
{
	static class UFunction* Func = nullptr;
