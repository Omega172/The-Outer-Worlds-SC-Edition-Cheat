...
// bool                                    Param_Pause                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
bool UFaceFXComponent::JumpTo(float Position, bool Param_Pause, class UFaceFXAnim* Animation, bool LoopAnimation, class USkeletalMeshComponent* SkelMeshComp, const class UObject* Caller)
{
	static class UFunction* Func = nullptr;
...
bool UFaceFXComponent::JumpToById(float Position, bool Param_Pause, class FName Group, class FName AnimName, bool LoopAnimation, class USkeletalMeshComponent* SkelMeshComp, const class UObject* Caller)
{
	static class UFunction* Func = nullptr;
