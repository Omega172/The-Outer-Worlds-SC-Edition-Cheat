...
public:
	...
	uint8                                         Pad_27CD[0x4];                                     // 0x052C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void BndEvt__Radial_K2Node_ComponentBoundEvent_1_SectionSelectedSignature__DelegateSignature(int32 Param_Index);
	void OnSectionSelected(int32 Param_Index);
	...
	void SetBackgroundVisibility(TArray<class UWeaponRadialBackgroundSection_BP_C*>& Array, int32 Param_Index, bool Enabled);
