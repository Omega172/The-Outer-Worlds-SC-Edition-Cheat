...
{
public:
	uint8                                         Pad_D33[0x8];                                      // 0x0098(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_D34[0x7];                                      // 0x00D1(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_D36[0x4];                                      // 0x010C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_D37[0x3];                                      // 0x0141(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_D38[0x88];                                     // 0x0030(0x0088)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_D39[0xD0];                                     // 0x00C0(0x00D0)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_D3A[0x8];                                      // 0x0198(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_D3B[0x8];                                      // 0x0128(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	bool JumpTo(float Position, bool Param_Pause, class UFaceFXAnim* Animation, bool LoopAnimation, class USkeletalMeshComponent* SkelMeshComp, const class UObject* Caller);
	bool JumpToById(float Position, bool Param_Pause, class FName Group, class FName AnimName, bool LoopAnimation, class USkeletalMeshComponent* SkelMeshComp, const class UObject* Caller);
